...
export const DUMMY_FACULTY_REQUESTS = [
  ...
  },
  {
    ...
    requestType: "deadline_extension",
    reason:
      "Hardware failure led to loss of training data. Student needs time to rebuild the dataset and retrain models.",
    status: "approved",
    resolvedBy: "coord001",
    resolvedAt: new Date("2026-01-05"),
    approvalReason:
      "Valid technical issue. Extension approved for 1 week to recover work.",
    createdAt: new Date("2026-01-03"),
  },
  {
    _id: "freq004",
    ...
    project: "proj020",
    projectName: "Blockchain Supply Chain Management",
    academicYear: "2025-2026",
    school: "SCOPE",
    program: "B.Tech",
    reviewType: "review2",
    ...
    reason:
      "Network connectivity issues prevented proper demonstration of blockchain features. Request for re-evaluation.",
    status: "approved",
    resolvedBy: "coord001",
    resolvedAt: new Date("2026-01-04"),
    approvalReason:
      "Technical issues confirmed. Resubmission allowed with proper setup.",
  ...
  },
  {
    ...
    requestType: "mark_edit",
    reason:
      "Innovation component was not properly evaluated. Student demonstrated novel security algorithm that wasn't captured in initial marking.",
    status: "rejected",
    resolvedBy: "coord001",
    resolvedAt: new Date("2026-01-03"),
    rejectionReason:
      "All components were evaluated properly. Original marks stand as per rubric.",
  ...
  },
  {
    ...
    project: "proj025",
    projectName: "E-Commerce Analytics Platform",
    academicYear: "2025-2026",
    school: "SITE",
    program: "MCA",
    reviewType: "review1",
    requestType: "deadline_extension",
    reason:
      "Family emergency required student to travel home for 10 days. Significant work time lost during critical development phase.",
    status: "pending",
    createdAt: new Date("2026-01-07"),
  },
  {
    ...
    studentRegNo: "22MCA1010",
    project: "proj030",
    projectName: "Cloud-based Document Management",
    academicYear: "2025-2026",
    school: "SITE",
    program: "MCA",
    reviewType: "review2",
    requestType: "resubmission",
    reason:
      "Server deployment failed during presentation due to university firewall issues. Unable to demonstrate cloud features properly.",
    status: "pending",
    createdAt: new Date("2026-01-06"),
  },
  {
    ...
    studentRegNo: "21BECE4005",
    project: "proj035",
    projectName: "Wireless Sensor Network for Agriculture",
    academicYear: "2025-2026",
    school: "SENSE",
    program: "B.Tech ECE",
    reviewType: "review1",
    requestType: "deadline_extension",
    reason:
      "Sensor components arrived late from vendor due to supply chain delays. Hardware assembly couldn't be completed on time.",
    status: "approved",
    resolvedBy: "coord002",
    resolvedAt: new Date("2026-01-05"),
    approvalReason:
      "Valid supply chain issue beyond student control. Extension granted for hardware setup.",
    createdAt: new Date("2026-01-02"),
  },
  {
    _id: "freq009",
    faculty: "fac007",
    facultyId: "fac007",
    facultyName: "Dr. V. Nair",
    facultyType: "panel",
    student: "stu040",
    studentName: "Amit Sharma",
    studentRegNo: "21BECE4010",
    project: "proj040",
    ...
    requestType: "mark_edit",
    reason:
      "Hardware demonstration component was scored incorrectly. All features worked properly but marks don't reflect performance.",
    status: "pending",
    createdAt: new Date("2026-01-06"),
  },
  {
    ...
    studentRegNo: "22MSC6005",
    project: "proj045",
    projectName: "Big Data Analytics for Social Media",
    academicYear: "2025-2026",
    school: "SAS",
    ...
    requestType: "deadline_extension",
    reason:
      "Data privacy clearance from university ethics committee took longer than expected. Cannot proceed without proper approvals.",
    status: "approved",
    resolvedBy: "coord003",
    resolvedAt: new Date("2026-01-04"),
    approvalReason:
      "Ethics clearance delays are institutional. Extension approved for compliance.",
  ...
  },
  {
    ...
    studentRegNo: "22MSC6010",
    project: "proj050",
    projectName: "Machine Learning for Financial Forecasting",
    academicYear: "2025-2026",
    school: "SAS",
    program: "M.Sc Data Science",
    reviewType: "review2",
    requestType: "resubmission",
    reason:
      "API access to financial data was revoked mid-project due to policy changes. Need to demonstrate with alternative dataset.",
    status: "rejected",
    resolvedBy: "coord003",
    resolvedAt: new Date("2026-01-03"),
    rejectionReason:
      "Alternative datasets were provided in advance. Original evaluation stands.",
  ...
  },
  {
    ...
    faculty: "fac003",
    facultyId: "fac003",
    facultyName: "Dr. S. Bansal",
    facultyType: "panel",
    student: "stu012",
    studentName: "Arjun Patel",
    studentRegNo: "21BCE2012",
    project: "proj012",
    projectName: "Natural Language Processing Chatbot",
    academicYear: "2025-2026",
    school: "SCOPE",
    program: "B.Tech",
    reviewType: "review1",
    requestType: "mark_edit",
    reason:
      "Language model licensing issues weren't considered in evaluation. Student had to rebuild with open-source alternatives.",
    status: "pending",
    createdAt: new Date("2026-01-07"),
  },
];
