  ...
  return [
    {
      ...
      message:
        "Requesting extension for Review 3 due to pending dataset collection from traffic authority. Need 2 more weeks to complete implementation.",
      status: "pending",
      date: "2025-12-10",
    ...
    },
    {
      ...
      projectTitle: "AI-Based Traffic Management System",
      message:
        "Panel member unavailable for scheduled review. Requesting reschedule to next week.",
      status: "pending",
      date: "2025-12-09",
      school: SCHOOLS[0].name, // SCOPE
      program: scopePrograms[0].name, // B.Tech CSE
    },
    {
      ...
      message:
        "Medical emergency in family. Requesting postponement of Review 2 by one week.",
      status: "pending",
      date: "2025-12-09",
      school: SCHOOLS[0].name, // SCOPE
      program: scopePrograms[0].name, // B.Tech CSE
    },
    {
      ...
      message:
        "Hardware components delayed in shipment. Requesting 10-day extension for Review 3 demonstration.",
      status: "approved",
      date: "2025-12-08",
    ...
    },
    {
      ...
      message:
        "Conflict with final exams scheduled on same day as review. Requesting alternate date.",
      status: "pending",
      date: "2025-12-11",
      school: SCHOOLS[0].name, // SCOPE
      program: scopePrograms[0].name, // B.Tech CSE
    },
    {
      ...
      message:
        "Client feedback delayed. Need additional time to incorporate revisions in final presentation.",
      status: "pending",
      date: "2025-12-10",
    ...
    },
    {
      ...
      message:
        "Server issues affecting demo environment. IT team working on fix. Requesting 3-day postponement.",
      status: "rejected",
      date: "2025-12-07",
      school: SCHOOLS[3].name, // VITBS
      program: PROGRAMMES_BY_SCHOOL["4"][1].name, // MBA
      rejectionReason:
        "Insufficient notice. Please ensure technical setup is verified 48 hours before review.",
    },
    {
      id: 8,
      facultyId: 5,
      ...
      message:
        "Awaiting survey data from municipal corporation. Requesting extension to complete analysis phase.",
      status: "pending",
      date: "2025-12-11",
...
export const groupRequestsByFaculty = (requests) => {
  ...
  requests.forEach((request) => {
    const facultyId = request.facultyId || request.faculty;
